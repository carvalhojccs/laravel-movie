...
<div class="grid grid-cols-1 gap-6 p-6 bg-gray-200 bg-opacity-25 dark:bg-gray-800 md:grid-cols-2 lg:gap-8 lg:p-8">
    <div>
        <div class="flex items-center">
            ...
            <h2 class="ml-3 text-xl font-semibold text-gray-900 dark:text-white">
                <span class="text-xl font-bold text-blue-500">{{ $users->count() }}</span> {{ __('Users in Database') }}
            </h2>
        </div>
    </div>
    ...
    <div>
        <div class="flex items-center">
            ...
            <h2 class="ml-3 text-xl font-semibold text-gray-900 dark:text-white">
                <span class="text-xl font-bold text-blue-500">{{ $movies->count() }}</span> {{ __('Movies in Database') }}
            </h2>
        </div>
    </div>
    ...
    <div>
        <div class="flex items-center">
            ...
            <h2 class="ml-3 text-xl font-semibold text-gray-900 dark:text-white">
                <span class="text-xl font-bold text-blue-500">{{ $series->count() }}</span> {{ __('Series in Database') }}
            </h2>
        </div>
    ...
    <div>
        <div class="flex items-center">
            ...
            <h2 class="ml-3 text-xl font-semibold text-gray-900 dark:text-white">
                {{ $casts->count() }} {{ __('Casts in Database') }}
            </h2>
        </div>
